...
// User storage table - Modified for access code authentication
export const users = pgTable("users", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  fullName: varchar("full_name").notNull(), // Nome completo es: "SIMONE CHELLI"
  accessCode: varchar("access_code").unique().notNull(), // Codice identificativo (lowercase per case-insensitive)
